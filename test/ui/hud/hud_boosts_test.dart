...
void main() {
  ...
  // The polish is NOT a pill: the income breakdown carries it, with its
  // minutes, and the bar has no room to give.
  test('the trophy polish is not on the bar', () {
    expect(
      hudBoostsFor(save({'trophyPolishUntil': _now + 22 * _minute}), nowMs: _now),
      isEmpty,
    );
  });
