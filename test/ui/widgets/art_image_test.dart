...
Future<ResizeImage> pumpIn(WidgetTester tester, Size box) async {
...
void main() {
  testWidgets('a zero-width box never asks for a decode with a zero side', (
    ...
    final resize = await pumpIn(tester, const Size(0, 62));
  ...
  testWidgets('and a real box still decodes at its own size', (tester) async {
    ...
    final resize = await pumpIn(tester, const Size(300, 168));
