...
const OVERRIDES = {
  ...
  // **THE COAT AND THE SUIT ARE THE PORT'S OWN.** The spec's overlays have
  // since been cut back to a plain body and a collar; these carry the
  // buttons, belt, pockets and lapels the port shipped with, so a regeneration
  // no longer strips them — plus a coat collar, a rear pocket and lapel
  // edges, and a pocket square, a second button and a hem line on the suit.
  managerOutfits: {
    coat:
      ...
      '<path d="M64.8 65.4 L67.6 64.6 L69 74 L66.2 74.6 Z" fill="#7ac47e" stroke="rgba(0,0,0,0.42)" stroke-width="0.9" stroke-linejoin="round"/>' +
      '<path d="M52.4 58.6 C55.6 62.4 61.2 63.2 67.6 61 L68.2 63.6 C61.4 66.2 55.4 65.4 51.6 61.6 Z" fill="#1b202a"/>' +
      '<path d="M52.3 60 L58.9 64.2" fill="none" stroke="rgba(255,255,255,0.16)" stroke-width="0.5"/>' +
      '<path d="M68.3 60.6 L61.9 64.6" fill="none" stroke="rgba(255,255,255,0.16)" stroke-width="0.5"/>' +
      '<path d="M48.6 95.4 L56.4 95.4 L56.5 98.9 L48.7 98.9 Z" fill="#1b202a" stroke="rgba(255,255,255,0.14)" stroke-width="0.5" stroke-linejoin="round"/>' +
      '<path d="M66.2 65 L67.1 110.6" fill="none" stroke="rgba(255,255,255,0.10)" stroke-width="0.6"/>' +
      '',
    suit:
      ...
      '<circle cx="64.6" cy="72.6" r="1.05" fill="#272b36"/>' +
      '<path d="M53.4 74.4 L58.2 74.4 L58.3 76.4 L53.5 76.4 Z" fill="#272b36" stroke="rgba(255,255,255,0.14)" stroke-width="0.5"/>' +
      '<path d="M54 74.4 L57.4 74.4 L57.2 73.2 L54.4 73.2 Z" fill="#f2f2f2"/>' +
      '<circle cx="64.9" cy="80.4" r="1.05" fill="#272b36"/>' +
      '<path d="M50.3 101.2 L65 101.2" fill="none" stroke="rgba(255,255,255,0.10)" stroke-width="0.6"/>' +
      '<path d="M55.2 61.6 L62.4 69.4" fill="none" stroke="rgba(255,255,255,0.12)" stroke-width="0.5"/>' +
      '',
  },
};

const SHADED = new Set(['managerHats', 'managerBeards', 'managerOutfits']);
