...
const Map<String, String> deCopy = <String, String>{
  ...
  'coach.bid.relay': '{club} haben angerufen, Chef. Sie wollen {player} und legen {price} auf den Tisch. Du verlierst seine +{rate} Einnahmen.',
  ...
  'shop.coin_value_badge': '+{pct}% Gegenwert',
  'agegate.purchases_body':
      'Münzpakete ({min} – {max}), Energiepakete und ein VIP-Pass sind '
  ...
  'matchtrait.when.home': "Zu Hause",
  'matchtrait.when.away': "Auswärts",
  'matchtrait.when.strongerOpponent': "Gegen ein stärkeres Team",
  'matchtrait.when.firstTwenty': "In den ersten zwanzig Minuten",
  'matchtrait.when.relegationZone': "In der Abstiegszone",
  'matchtrait.when.lastFifteen': "In den letzten fünfzehn Minuten",
  'matchtrait.when.cupTie': "Im Pokal",
  'matchtrait.when.superSub': "Spät eingewechselt",
  'matchtrait.when.derby': "Im Derby",
  'matchtrait.when.tenMen': "Mit zehn Mann",
  'matchtrait.when.booked': "Nach Gelb",
  'matchtrait.when.injuryShrug': "Bei einer Verletzung",
  'matchtrait.when': "Wann",
  'matchtrait.effect.rating': "+{n}% Wertung",
  ...
  'boost.park_the_bus.desc': "Alle hinter den Ball – fünfundzwanzig Minuten lang passiert nichts",
  'boost.var_review.name': "Videobeweis",
  'boost.var_review.desc': "Einen Platzverweis kippen – der Spieler bleibt, mit Gelb",
  ...
  'boost.bus.over': "Die Fesseln fallen, und es gibt wieder Räume.|Der Block löst sich. Beide Mannschaften dürfen wieder spielen.",
  'boost.var.overturned': "Der Videobeweis kippt die Entscheidung. Die Karte wird zurückgenommen und {player} bleibt drauf.|Der Schiedsrichter geht zum Monitor und kommt kopfschüttelnd zurück. {player} ist begnadigt.",
  ...
  'boost.sharp_shooting.name': "Torgarantie",
  'boost.sharp_shooting.desc': "Jede Chance sitzt — 25 Minuten lang schärfer im Abschluss",
  'boost.quiet_word.name': "Leises Wort",
  'boost.quiet_word.desc': "Ein Wort ins Ohr des Schiedsrichters — eine Gelbe Karte wird gestrichen",
  'boost.quiet_word.idle': "Niemand hat Gelb",
  'boost.sharp.live': "Der Abschlusstrainer hat gesprochen. Jeder Schuss sieht nach Tor aus.|Die Schuhe sitzen fester. Die Chancen werden verwertet.",
  'boost.sharp.over': "Die Torgarantie erlischt, eine Chance ist wieder nur eine Chance.|Die Glückssträhne endet. Zurück zum Erarbeiten.",
  'boost.quiet.wiped': "Ein leises Wort mit dem Schiedsrichter, und {player}s Gelbe ist vergessen.|Der vierte Offizielle redet mit. {player}s Verwarnung landet im Papierkorb.",
  'coach.red_card.var_hint': "Du hast einen Videobeweis. Fordere ihn von der Bank an, bevor es weitergeht.",
  'coach.injury.physio_hint': "Du hast einen Wunderschwamm. Setze ihn von der Bank ein, bevor es weitergeht.",
  'match.active.title': "Aktiv",
  'match.active.until': "bis zur {minute}.",
  'matchtrait.name.fortress': "Festung",
  'matchtrait.desc.fortress': "Unverrückbar zu Hause – aber nur zu Hause",
  'matchtrait.name.away_day': "Auswärtsheld",
  'matchtrait.desc.away_day': "Liebt feindliche Stadien – blüht in der Fremde auf",
  'matchtrait.name.big_game': "Mann für große Spiele",
  'matchtrait.desc.big_game': "Ist da, wenn der Gegner besser ist",
  'matchtrait.name.fast_starter': "Blitzstarter",
  'matchtrait.desc.fast_starter': "Aus den Blöcken geschossen – riesig in den ersten zwanzig Minuten",
  'matchtrait.name.relegation_scrapper': "Abstiegskämpfer",
  'matchtrait.desc.relegation_scrapper': "Kämpft am härtesten, wenn der Abstieg droht",
  'matchtrait.name.last_gasp': "Letzter Atemzug",
  'matchtrait.desc.last_gasp': "Findet in den Schlussminuten noch etwas",
  'matchtrait.name.cup_fighter': "Pokalkämpfer",
  'matchtrait.desc.cup_fighter': "Gemacht für den Pokal – nichts sonst weckt diesen Biss",
  'matchtrait.name.super_sub': "Joker",
  'matchtrait.desc.super_sub': "Verheerend von der Bank in den letzten zwanzig Minuten",
  'matchtrait.name.derby_devil': "Derbyteufel",
  'matchtrait.desc.derby_devil': "Lebt für das Spiel gegen den Erzrivalen",
  'matchtrait.name.ten_man_wall': "Mauer zu zehnt",
  'matchtrait.desc.ten_man_wall': "Sammelt die zehn – hebt alle, die noch auf dem Platz stehen",
  'matchtrait.name.ice_veins': "Eiskalt",
