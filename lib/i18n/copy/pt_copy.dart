...
const Map<String, String> ptCopy = <String, String>{
  ...
  'match.subs.pick_off': 'Toque num jogador para tirá-lo.',
  'match.subs.pick_on': 'Toque num reserva para colocá-lo (verde = melhor posição).',
  'match.subs.none_left': 'Não há mais substituições.',
  'match.subs.feed': '{off} sai, {on} entra.',
  'match.subs.feed_on': '{on} entra.',
  'tut.loan_boost.title': '⭐ Chegam astros emprestados!',
  'tut.loan_boost.body': 'Usei alguns contatos… <strong>craques</strong> topraram se juntar a nós para a sua primeira partida! Eles saem logo depois — mas vamos aproveitar ao máximo!',
  'tut.loan_boost.btn': 'Ver meu elenco →',
  'tut.loan_depart.title': 'Agora vamos construir nosso time',
  'tut.loan_depart.body': 'Os astros emprestados se foram — mas provaram que podemos competir. Agora vamos construir algo que é <strong>nosso</strong>. Aqui estão <strong>500 moedas</strong> para começar. Vou estar no canto inferior esquerdo sempre que tiver um conselho.',
  'tut.loan_depart.btn': 'Vamos construir! →',
  'difficulty.switch.confirm': 'Vamos lá',
  'difficulty.switch.toHard': 'Modo Pro: cada jogador se cansa durante uma partida — gerencie a energia do seu elenco e revezar o banco para manter as pernas descansadas. Posso ajudar a escolher seu time titular mais descansado, mas vou ficar quieto sobre tática. Trocar vai te fazer recomeçar.',
  'difficulty.switch.toEasy': 'Modo Casual: sem cansaço dos jogadores, o banco serve só para trocas táticas e lesões. Seleção automática e dicas do treinador voltam. Trocar vai te fazer recomeçar.',
  'coachtip.subs_bench.title': 'Você tem um banco',
  'coachtip.subs_bench.body': 'Toque em Substituições durante uma partida para abrir seu banco — você tem 5 trocas por partida, e o cronômetro para enquanto você escolhe. Lesões também passam por lá agora: quando alguém se machuca, a camisa dele sai de campo e a vaga fica vazia até você colocar um substituto, então não deixe assim.',
  'coachtip.try_hard_mode.title': 'Topa um desafio?',
  'coachtip.try_hard_mode.body': 'Você percorreu um longo caminho, chefe. Pronto para o modo Pro? Os jogadores se cansam durante as partidas, então revezar o elenco e usar o banco realmente importa — toque em Auto e eu escolho seu XI legal mais descansado — e vou ficar quieto sobre tática. Isso começa um time novo — só se você topar.',
  'coachtip.try_hard_mode.cta': 'Abrir Configurações',
  'coach.match.tired': '{name} está exausto — coloque um jogador descansado!',
  'coach.tactic_tip.open_dominant': 'Os dois times vão marcar, mas somos claramente mais fortes. {tactic} — jogue para vencer.',
  'coach.tactic_tip.open_favoured': 'Os dois lados vão criar chances e devemos levar vantagem. {tactic} para controlar o jogo.',
  'coach.tactic_tip.open_even': 'Os dois times vão criar chances. {tactic} — atinja {opp} no contra-ataque.',
  'coach.tactic_tip.open_underdog': '{opp} são mais fortes, mas vai ser aberto. {tactic} — aproveite suas chances quando surgirem.',
  'coach.tactic_tip.exploit_their_def': 'A defesa de {opp} está exposta. {tactic} — jogue para vencer.',
  'coach.tactic_tip.counter_their_atk': '{opp} é perigoso indo para o ataque. {tactic} — segure e responda no contra-ataque.',
  'coach.tactic_tip.park_underdog': '{opp} é uma ameaça real e vamos ter dificuldade para marcar. {tactic} — limite o estrago.',
  'coach.tactic_tip.tight_favoured': 'Partida equilibrada, mas temos a vantagem. {tactic} — crie a chance.',
  'coach.tactic_tip.tight_underdog': 'Difícil marcar dos dois lados. {tactic} — mantenha a disciplina.',
  'ach.cat.hardmode': 'Modo Pro',
  'toast.energy_refilled': 'Energia do elenco recarregada!',
  'toast.no_fit_players': 'Jogadores em condição insuficientes — deixe-os descansar ou assista a um anúncio para recarregar.',
  'trait.name.iron_lungs': 'Pulmões de Ferro',
  'trait.desc.iron_lungs': 'Motor incansável — a energia cai mais devagar durante as partidas (modo Pro)',
  'champ.title': 'CAMPEÕES!',
  'champ.subtitle': 'Champions League conquistada',
  'champ.body': 'Você conquistou todas as divisões e se ergueu acima de todos os rivais. Você está sozinho no topo, o maior técnico do mundo.',
  'champ.prestige_teaser': 'Reinicie e suba de novo a partir da Liga Dominical com um <strong>bônus de renda ×{mult}</strong> permanente. As conquistas da sua carreira ficam com você para sempre.',
  'champ.new_adventure': '🌟 Começar nova aventura',
  'champ.defend': '⚽ Defender o título',

  // ── The side dial on the squad tab ────────────────────────────────────
  'squad.side.label': 'Atacar pela',
  'squad.side.balanced': 'Equilibrado',
  'squad.side.balanced.hint': 'Os ataques começam onde a formação os coloca.',
  'squad.side.left': 'Esquerda',
  'squad.side.left.hint': 'A maioria dos ataques começa pelo lado esquerdo.',
