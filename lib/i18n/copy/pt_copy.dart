...
const Map<String, String> ptCopy = <String, String>{
  ...
  'matchtrait.when.home': "Em casa",
  'matchtrait.when.away': "Fora de casa",
  'matchtrait.when.strongerOpponent': "Contra uma equipa mais forte",
  'matchtrait.when.firstTwenty': "Os primeiros vinte minutos",
  'matchtrait.when.relegationZone': "Na zona de despromoção",
  'matchtrait.when.lastFifteen': "Os últimos quinze minutos",
  'matchtrait.when.cupTie': "Na taça",
  'matchtrait.when.superSub': "Lançado tarde",
  'matchtrait.when.derby': "Num dérbi",
  'matchtrait.when.tenMen': "Com dez",
  'matchtrait.when.booked': "Após um amarelo",
  'matchtrait.when.injuryShrug': "Ao lesionar-se",
  'matchtrait.when': "Quando",
  'matchtrait.effect.rating': "+{n}% de avaliação",
  ...
  'boost.park_the_bus.desc': "Todos atrás da bola: um jogo travado por vinte e cinco minutos",
  'boost.var_review.name': "Revisão do VAR",
  'boost.var_review.desc': "Reverte uma expulsão: o jogador fica em campo, com amarelo",
  ...
  'boost.roar.live': "O técnico se vira para a torcida e o estádio explode.|Uma parede de barulho desce das arquibancadas. Cada dividida é um grito.",
  'boost.roar.over': "O barulho assenta e o jogo reencontra o ritmo.|A torcida recupera o fôlego. De volta ao futebol.",
  'boost.bus.live': "Todos atrás da bola. Vão segurar este resultado.|Duas linhas de cinco e nem um centímetro cedido. Isto está trancado.",
  'boost.bus.over': "As correntes caem e volta a haver espaço.|O bloco afrouxa. Os dois times podem jogar de novo.",
  'boost.var.overturned': "O VAR reverteu. O cartão é retirado e {player} fica em campo.|O árbitro vai ao monitor e volta balançando a cabeça. {player} está perdoado.",
  ...
  'boost.sharp_shooting.name': "Pontaria letal",
  'boost.sharp_shooting.desc': "Cada oportunidade é boa — a finalização afina-se durante vinte e cinco minutos",
  'boost.quiet_word.name': "Palavrinha",
  'boost.quiet_word.desc': "Uma palavrinha ao árbitro — um cartão amarelo é apagado",
  'boost.quiet_word.idle': "Ninguém tem amarelo",
  'boost.sharp.live': "O treinador de finalização falou. Cada remate parece entrar.|Botas bem apertadas. As oportunidades estão a ser convertidas.",
  'boost.sharp.over': "O radar arrefece e uma oportunidade volta a ser uma oportunidade.|A fase boa passa. De volta a merecê-las.",
  'boost.quiet.wiped': "Uma palavrinha ao árbitro, e o amarelo de {player} fica esquecido.|O quarto árbitro intervém. A admoestação de {player} vai para o lixo.",
  'coach.red_card.var_hint': "Você tem uma Revisão do VAR. Peça-a do banco antes de o jogo recomeçar.",
  'coach.injury.physio_hint': "Você tem uma Esponja mágica. Use-a do banco antes de o jogo recomeçar.",
  'match.active.title': "Ativos",
  'match.active.until': "até o {minute}'",
  'matchtrait.name.fortress': "Fortaleza",
  'matchtrait.desc.fortress': "Intransponível em casa, mas só em casa",
  'matchtrait.name.away_day': "Herói fora de casa",
  'matchtrait.desc.away_day': "Adora um campo hostil: brilha longe de casa",
  'matchtrait.name.big_game': "Jogador de decisão",
  'matchtrait.desc.big_game': "Aparece contra o adversário melhor",
  'matchtrait.name.fast_starter': "Largada rápida",
  'matchtrait.desc.fast_starter': "Sai voando: enorme nos primeiros vinte minutos",
  'matchtrait.name.relegation_scrapper': "Brigador do rebaixamento",
  'matchtrait.desc.relegation_scrapper': "Luta mais quando o rebaixamento é real",
  'matchtrait.name.last_gasp': "Último suspiro",
  'matchtrait.desc.last_gasp': "Encontra algo a mais nos minutos finais",
  'matchtrait.name.cup_fighter': "Copeiro",
  'matchtrait.desc.cup_fighter': "Feito para a copa: nada mais desperta essa garra",
  'matchtrait.name.super_sub': "Super-reserva",
  'matchtrait.desc.super_sub': "Devastador saindo do banco nos últimos vinte minutos",
  'matchtrait.name.derby_devil': "Diabo do clássico",
  'matchtrait.desc.derby_devil': "Vive para o jogo da rivalidade",
  'matchtrait.name.ten_man_wall': "Muralha de dez",
  'matchtrait.desc.ten_man_wall': "Reúne os dez: ergue todos que sobram em campo",
  'matchtrait.name.ice_veins': "Sangue frio",
