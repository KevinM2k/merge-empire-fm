...
const Map<String, String> itCopy = <String, String>{
  ...
  'shop.coin_value_badge': '+{pct}% di valore',
  'agegate.purchases_body':
      'Sono disponibili pacchetti di monete ({min} – {max}), pacchetti di '
      'energia e un pass VIP. Tutti gli acquisti vengono elaborati in modo '
  ...
  'matchtrait.when.home': "In casa",
  'matchtrait.when.away': "In trasferta",
  'matchtrait.when.strongerOpponent': "Contro una squadra più forte",
  'matchtrait.when.firstTwenty': "I primi venti minuti",
  'matchtrait.when.relegationZone': "In zona retrocessione",
  'matchtrait.when.lastFifteen': "Gli ultimi quindici minuti",
  'matchtrait.when.cupTie': "In coppa",
  'matchtrait.when.superSub': "Entrato tardi",
  'matchtrait.when.derby': "In un derby",
  'matchtrait.when.tenMen': "In dieci",
  'matchtrait.when.booked': "Dopo un giallo",
  'matchtrait.when.injuryShrug': "Su infortunio",
  'matchtrait.when': "Quando",
  'matchtrait.effect.rating': "+{n}% di valutazione",
  ...
  'boost.park_the_bus.desc': "Tutti dietro la palla: una partita bloccata per venticinque minuti",
  'boost.var_review.name': "Revisione VAR",
  'boost.var_review.desc': "Annulla un'espulsione: il giocatore resta in campo, con un giallo",
  ...
  'boost.bus.over': "Cadono le catene e torna lo spazio.|Il blocco si scioglie. Le due squadre possono tornare a giocare.",
  'boost.var.overturned': "Il VAR annulla la decisione. Il cartellino è ritirato e {player} resta in campo.|L'arbitro va al monitor e torna scuotendo la testa. {player} è graziato.",
  ...
  'boost.sharp_shooting.name': "Mira letale",
  'boost.sharp_shooting.desc': "Ogni occasione è buona — la finalizzazione si affina per venticinque minuti",
  'boost.quiet_word.name': "Parolina",
  'boost.quiet_word.desc': "Una parolina all'arbitro — un cartellino giallo viene cancellato",
  'boost.quiet_word.idle': "Nessuno è ammonito",
  'boost.sharp.live': "Il preparatore degli attaccanti ha parlato. Ogni tiro sembra entrare.|Scarpe allacciate strette. Le occasioni vengono buttate dentro.",
  'boost.sharp.over': "Il radar si raffredda e un'occasione torna un'occasione.|Il periodo d'oro finisce. Si torna a guadagnarsele.",
  'boost.quiet.wiped': "Una parolina all'arbitro, e il giallo di {player} è dimenticato.|Il quarto uomo interviene. L'ammonizione di {player} finisce nel cestino.",
  'coach.red_card.var_hint': "Hai una Revisione VAR. Chiedila dalla panchina prima che il gioco riprenda.",
  'coach.injury.physio_hint': "Hai una Spugna magica. Usala dalla panchina prima che il gioco riprenda.",
  'match.active.title': "Attivi",
  'match.active.until': "fino al {minute}'",
  'matchtrait.name.fortress': "Fortezza",
  'matchtrait.desc.fortress': "Inamovibile in casa, ma solo in casa",
  'matchtrait.name.away_day': "Eroe in trasferta",
  'matchtrait.desc.away_day': "Adora i campi ostili: brilla lontano da casa",
  'matchtrait.name.big_game': "Uomo delle grandi partite",
  'matchtrait.desc.big_game': "Si presenta contro l'avversario più forte",
  'matchtrait.name.fast_starter': "Partenza a razzo",
  'matchtrait.desc.fast_starter': "Scatta dai blocchi: enorme nei primi venti minuti",
  'matchtrait.name.relegation_scrapper': "Lottatore da retrocessione",
  'matchtrait.desc.relegation_scrapper': "Combatte più forte quando la retrocessione è vera",
  'matchtrait.name.last_gasp': "Ultimo respiro",
  'matchtrait.desc.last_gasp': "Trova ancora qualcosa nei minuti finali",
  'matchtrait.name.cup_fighter': "Uomo da coppa",
  'matchtrait.desc.cup_fighter': "Fatto per la coppa: nient'altro tira fuori la stessa grinta",
  'matchtrait.name.super_sub': "Super riserva",
  'matchtrait.desc.super_sub': "Devastante dalla panchina negli ultimi venti minuti",
  'matchtrait.name.derby_devil': "Diavolo del derby",
  'matchtrait.desc.derby_devil': "Vive per la partita della rivalità",
  'matchtrait.name.ten_man_wall': "Muro in dieci",
  'matchtrait.desc.ten_man_wall': "Raduna i dieci: solleva tutti quelli rimasti in campo",
  'matchtrait.name.ice_veins': "Sangue freddo",
  ...
  'coach.tactic_tip.counter_their_atk': "{opp} sono pericolosi in avanti. {tactic}: assorbire e colpire in ripartenza.",
  'coach.tactic_tip.exploit_their_def': "La difesa di {opp} è scoperta. {tactic}: giocare per vincere.",
  'coach.tactic_tip.open_dominant': "Segneranno entrambe, ma siamo nettamente più forti. {tactic}: giocare per vincere.",
  'coach.tactic_tip.open_even': "Entrambe le squadre avranno occasioni. {tactic}: colpire {opp} in contropiede.",
  'coach.tactic_tip.open_favoured': "Occasioni da entrambe le parti, ma dovremmo spuntarla. {tactic} per controllare la partita.",
  'coach.tactic_tip.open_underdog': "{opp} sono più forti, ma sarà una partita aperta. {tactic}: sfruttare le occasioni quando arrivano.",
  'coach.tactic_tip.park_underdog': "{opp} sono una vera minaccia e faremo fatica a segnare. {tactic}: limitare i danni.",
  'coach.tactic_tip.tight_favoured': "Partita chiusa, ma abbiamo qualcosa in più. {tactic}: costruire l'occasione.",
  'coach.tactic_tip.tight_underdog': "Difficile segnare per entrambe. {tactic}: restare disciplinati.",
  'club.effect.cooldown': "-{pct}% ricarica",
  'club.stats.tier_value': "Livello {tier}",
  'feature.effect.rating': "+{n} valutazione",
  'league.rating_penalty': "(−{n} valutazione)",
  'pi.stat.rating': "Valutazione",
  ...
  'boost.pitch.none': "Finiti: comprane altri nel Negozio",
};
