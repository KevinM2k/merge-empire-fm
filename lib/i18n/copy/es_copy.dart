...
const Map<String, String> esCopy = <String, String>{
  ...
  'matchtrait.when.home': "En casa",
  'matchtrait.when.away': "Fuera de casa",
  'matchtrait.when.strongerOpponent': "Contra un rival más fuerte",
  'matchtrait.when.firstTwenty': "Los primeros veinte minutos",
  'matchtrait.when.relegationZone': "En zona de descenso",
  'matchtrait.when.lastFifteen': "Los últimos quince minutos",
  'matchtrait.when.cupTie': "En copa",
  'matchtrait.when.superSub': "Saliendo tarde",
  'matchtrait.when.derby': "En un derbi",
  'matchtrait.when.tenMen': "Con diez",
  'matchtrait.when.booked': "Tras una amarilla",
  'matchtrait.when.injuryShrug': "Al lesionarse",
  'matchtrait.when': "Cuándo",
  'matchtrait.effect.rating': "+{n}% de valoración",
  ...
  'boost.park_the_bus.desc': "Todos detrás del balón: un partido cerrado durante veinticinco minutos",
  'boost.var_review.name': "Revisión del VAR",
  'boost.var_review.desc': "Anula una expulsión: el jugador sigue en el campo, con amarilla",
  ...
  'boost.feed.on': "Activo",
  'boost.feed.off': "Fin",
  'boost.crowd_roar.effect': "+10% valoración, todo el equipo",
  'boost.sharp_shooting.effect': "+25% ATQ",
  'boost.park_the_bus.effect': "-25% ATQ, ambos equipos",
  ...
  'boost.bus.over': "Se sueltan las cadenas y vuelve a haber espacio.|El bloque se afloja. Los dos equipos pueden volver a jugar.",
  'boost.var.overturned': "El VAR lo anula. Se retira la tarjeta y {player} sigue en el campo.|El árbitro va al monitor y vuelve negando con la cabeza. {player} se libra.",
  ...
  'boost.sharp_shooting.name': "Puntería letal",
  'boost.sharp_shooting.desc': "Cada ocasión es buena — la definición se afila durante veinticinco minutos",
  'boost.quiet_word.name': "Palabra discreta",
  'boost.quiet_word.desc': "Una palabra al oído del árbitro — se borra una tarjeta amarilla",
  'boost.quiet_word.idle': "Nadie tiene amarilla",
  'boost.sharp.live': "El entrenador de delanteros ha hablado. Cada disparo parece gol.|Botas bien atadas. Las ocasiones que llegan se convierten.",
  'boost.sharp.over': "El radar se enfría y una ocasión vuelve a ser una ocasión.|Pasa la racha. Hay que volver a ganárselas.",
  'boost.quiet.wiped': "Una palabra discreta al árbitro, y la amarilla de {player} queda olvidada.|El cuarto árbitro interviene. La amonestación de {player} va a la papelera.",
  'coach.red_card.var_hint': "Tienes una Revisión del VAR. Pídela desde el banquillo antes de que se reanude el juego.",
  'coach.injury.physio_hint': "Tienes una Esponja mágica. Úsala desde el banquillo antes de que se reanude el juego.",
  'match.active.title': "Activos",
  'match.active.until': "hasta el {minute}'",
  'matchtrait.name.fortress': "Fortaleza",
  'matchtrait.desc.fortress': "Inamovible en casa, pero solo en casa",
  'matchtrait.name.away_day': "Héroe a domicilio",
  'matchtrait.desc.away_day': "Le encanta un campo hostil: brilla lejos de casa",
  'matchtrait.name.big_game': "Jugador de grandes citas",
  'matchtrait.desc.big_game': "Aparece contra el rival mejor",
  'matchtrait.name.fast_starter': "Salida rápida",
  'matchtrait.desc.fast_starter': "Sale disparado: enorme en los primeros veinte minutos",
  'matchtrait.name.relegation_scrapper': "Luchador del descenso",
  'matchtrait.desc.relegation_scrapper': "Pelea más cuando el descenso es real",
  'matchtrait.name.last_gasp': "Último aliento",
  'matchtrait.desc.last_gasp': "Encuentra algo más en los minutos finales",
  'matchtrait.name.cup_fighter': "Copero",
  'matchtrait.desc.cup_fighter': "Hecho para la copa: nada más saca esa garra",
  'matchtrait.name.super_sub': "Supersuplente",
  'matchtrait.desc.super_sub': "Devastador desde el banquillo en los últimos veinte minutos",
  'matchtrait.name.derby_devil': "Diablo del derbi",
  'matchtrait.desc.derby_devil': "Vive para el partido del rencor",
  'matchtrait.name.ten_man_wall': "Muro de diez",
  'matchtrait.desc.ten_man_wall': "Reúne a los diez: eleva a todos los que quedan en el campo",
  'matchtrait.name.ice_veins': "Sangre fría",
