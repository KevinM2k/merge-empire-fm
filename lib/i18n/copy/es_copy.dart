...
const Map<String, String> esCopy = <String, String>{
  ...
  'match.analysis.title':
      'Dónde se decidió',
  'match.analysis.hint':
      'Dónde tuvo el balón cada equipo, atacando hacia arriba. Las bandas son las de cada equipo.',
  ...
  'match.analysis.duel_record':
      '{name} ganó {won} de {total} duelos.',
  'report.zone.down_right':
      '{club} atacó por la derecha toda la tarde, y casi todo el peligro nació ahí.|Casi todo lo que construyó {club} llegó por la banda derecha.',
  'report.zone.down_left':
      '{club} atacó por la izquierda toda la tarde, y casi todo el peligro nació ahí.|Casi todo lo que construyó {club} llegó por la banda izquierda.',
  'report.zone.through_middle':
      '{club} entró por el centro y apenas necesitó las bandas.|Todo fue por el medio para {club}, en línea recta hacia la portería.',
  'report.zone.their_right':
      '{opp} insistió por su derecha, y de ahí salió casi todo su peligro.|Casi todo lo que generó {opp} llegó por su banda derecha.',
  'report.zone.their_left':
      '{opp} insistió por su izquierda, y de ahí salió casi todo su peligro.|Casi todo lo que generó {opp} llegó por su banda izquierda.',
  'report.zone.their_middle':
      '{opp} fue directo por el centro contra {club} y apenas usó las bandas.|Todo fue por el medio para {opp}.',
  'report.duel.dominant':
      '{name} ganó casi todo lo que le llegó.|Nadie de {opp} pudo con {name} en toda la tarde.',
  'report.duel.busy':
      '{name} estuvo en el meollo del partido de principio a fin.|Buena parte del juego pasó por {name}, para bien y para mal.',
  'report.duel.struggled':
      '{name} tuvo una tarde difícil, perdiendo la mayoría de sus duelos.|No le salió a {name}, que perdió más duelos de los que ganó.',
  ...
  'match.subs.pick_off': 'Toca a un jugador para sacarlo.',
  'match.subs.pick_on': 'Toca a un suplente para meterlo (verde = mejor posición).',
  'match.subs.none_left': 'No quedan cambios.',
  'match.subs.feed': '{off} sale, {on} entra.',
  'match.subs.feed_on': '{on} entra.',
  'tut.loan_boost.title': '⭐ ¡Llegan estrellas cedidas!',
  'tut.loan_boost.body': 'He tirado de algunos contactos… ¡<strong>jugadores top</strong> han aceptado unirse a nosotros para tu primer partido! Se van justo después — ¡pero aprovechémoslo al máximo!',
  'tut.loan_boost.btn': 'Ver mi plantilla →',
  'tut.loan_depart.title': 'Ahora, construyamos nuestro equipo',
  'tut.loan_depart.body': 'Las estrellas cedidas se han ido — pero demostraron que podemos competir. Ahora construimos algo que es <strong>nuestro</strong>. Aquí tienes <strong>500 monedas</strong> para empezar. Estaré abajo a la izquierda en cuanto tenga un consejo.',
  'tut.loan_depart.btn': '¡A construir! →',
  'difficulty.switch.confirm': 'Vamos allá',
  'difficulty.switch.toHard': 'Modo Pro: cada jugador se cansa durante un partido — gestiona la energía de tu plantilla y rota el banquillo para mantener las piernas frescas. Puedo ayudarte a elegir tu once más fresco, pero me quedaré callado sobre táctica. Cambiar hará que empieces de nuevo.',
  'difficulty.switch.toEasy': 'Modo Casual: sin fatiga de jugadores, el banquillo es solo para cambios tácticos y lesiones. Vuelven la selección automática y los consejos del entrenador. Cambiar hará que empieces de nuevo.',
  'coachtip.subs_bench.title': 'Tienes un banquillo',
  'coachtip.subs_bench.body': 'Toca Cambios durante un partido para abrir tu banquillo — tienes 5 cambios por partido, y el reloj se detiene mientras eliges. Las lesiones también pasan por ahí ahora: cuando alguien cae, su camiseta sale del campo y el hueco queda vacío hasta que metas un sustituto, así que no lo dejes así.',
  'coachtip.try_hard_mode.title': '¿Te apetece un reto?',
  'coachtip.try_hard_mode.body': 'Has recorrido un largo camino, jefe. ¿Listo para el modo Pro? Los jugadores se cansan durante los partidos, así que rotar la plantilla y usar el banquillo importa de verdad — toca Auto y yo elijo tu once legal más fresco — y me quedaré callado sobre táctica. Empieza un equipo nuevo — solo si te apuntas.',
  'coachtip.try_hard_mode.cta': 'Abrir Ajustes',
  'coach.match.tired': '¡{name} está agotado — mete a un jugador fresco!',
  'coach.tactic_tip.open_dominant': 'Los dos equipos van a marcar, pero nosotros somos claramente superiores. {tactic} — ve a por la victoria.',
  'coach.tactic_tip.open_favoured': 'Ambos lados van a crear ocasiones y deberíamos imponernos. {tactic} para controlar el partido.',
  'coach.tactic_tip.open_even': 'Los dos equipos van a crear ocasiones. {tactic} — golpea a {opp} al contragolpe.',
  'coach.tactic_tip.open_underdog': '{opp} son más fuertes pero el partido será abierto. {tactic} — aprovecha tus ocasiones cuando lleguen.',
  'coach.tactic_tip.exploit_their_def': 'La defensa de {opp} está expuesta. {tactic} — ve a por la victoria.',
  'coach.tactic_tip.counter_their_atk': '{opp} son peligrosos yendo hacia adelante. {tactic} — resiste y responde al contragolpe.',
  'coach.tactic_tip.park_underdog': '{opp} son una amenaza real y nos costará marcar. {tactic} — limita el daño.',
  'coach.tactic_tip.tight_favoured': 'Un partido ajustado pero tenemos la ventaja. {tactic} — crea la ocasión.',
  'coach.tactic_tip.tight_underdog': 'Difícil marcar para los dos lados. {tactic} — mantén la disciplina.',
  'ach.cat.hardmode': 'Modo Pro',
  'toast.energy_refilled': '¡Energía de la plantilla recargada!',
  'toast.no_fit_players': 'No hay suficientes jugadores en forma — déjalos descansar o mira un anuncio para recargar.',
  'trait.name.iron_lungs': 'Pulmones de hierro',
  'trait.desc.iron_lungs': 'Motor incansable — la energía baja más despacio durante los partidos (modo Pro)',
  'champ.title': '¡CAMPEONES!',
  'champ.subtitle': 'Champions League conquistada',
  'champ.body': 'Has conquistado todas las divisiones y te has alzado por encima de todos tus rivales. Estás solo en la cima, el mejor mánager del mundo.',
  'champ.prestige_teaser': 'Reinicia y vuelve a subir desde la Liga Dominical con un <strong>bonus de ingresos ×{mult}</strong> permanente. Los logros de tu carrera te acompañan para siempre.',
  'champ.new_adventure': '🌟 Empezar nueva aventura',
  'champ.defend': '⚽ Defender el título',

  // ── The side dial on the squad tab ────────────────────────────────────
  'squad.side.label': 'Atacar por',
  'squad.side.balanced': 'Equilibrado',
  'squad.side.balanced.hint': 'Los ataques nacen donde los coloca la formación.',
  'squad.side.left': 'La izquierda',
  'squad.side.left.hint': 'La mayoría de los ataques nacen por la banda izquierda.',
  'squad.side.centre': 'El centro',
