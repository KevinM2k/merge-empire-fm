...
const Map<String, String> jaCopy = <String, String>{
  ...
  // ── PK戦を1本ずつ実況する ────────────────────────────────────────
  //
  // JSのこの演出は英語の直書きで`t()`キーがなく、生成カタログから移植できる
  // ものが何もなかった。ソファから直接の要望なので、ここに十言語ぶん書く。
  // {score}は文ではなく行が描く。
  'match.pens.head': 'PK戦',
  'match.pens.going':
      'PK戦に入る。|'
  ...
  'match.pens.sudden_death':
      '5本ずつ決めてまだ互角。サドンデスへ。|'
      'サドンデス突入。1本外せばそこで終わりだ。|'
      '5本ずつ。次のミスが決める。',
  'match.pens.scored':
      'ポスト際に突き刺さる。{who}が決めた。|'
      'キーパーは逆。{who}はきっちり決める。|'
      'ど真ん中、それでも入る。{who}が決めた。',
  'match.pens.missed':
      'セーブ！{who}は信じられない。|'
      'バーの上へ。{who}はスタンドに叩き込んでしまった。|'
      'ポストを叩いて外へ。{who}には最悪の瞬間だ。',
  'match.pens.opp_scored':
      '{them}が決める。文句のつけようがない。|'
      '{them}はトップコーナーへ。止められない。|'
      '{them}もきっちり沈める。',
  'match.pens.opp_missed':
      'セーブ！キーパーが読み切り、{them}が外した。|'
      '{them}はポストの外へ引っ掛ける。|'
      '{them}はバーの上。とんでもないミスだ。',
  'match.pens.through': '{us}がPK戦を制して勝ち上がる。',
  'match.pens.out': '{them}がPK戦を制した。{us}は敗退。',

  // ── そしてPK戦にもつれたカップ戦 ──────────────────────────────────
  //
  // 新しいキー。生成カタログの元になったJSの戦評はPK戦を知らなかったので、
  // 差し替えではなく追加になる。引き分けの見出しを置き換える。{score}は
  // 90分のスコア、{pens}はPK戦のスコアで、どちらもホーム側が先。
  'report.cup.pens_won':
      '試合終了、決着はPK戦へ。90分は{score}、{club}がPK戦を{pens}で制して'
          '勝ち上がる。|'
      'ホイッスルが鳴った時点で{score}。{club}はスポットキックで動じず、'
          '{pens}。{opp}は敗退。|'
      '終了、{score}、決めたのはPK戦だった。{pens}で{club}が突破する。',
  'report.cup.pens_lost':
      '試合終了、決着はPK戦へ。90分は{score}、{club}は{pens}で敗れて敗退。|'
      'ホイッスルが鳴った時点で{score}。{club}はスポットキックで決めきれず、'
          '{pens}。{opp}が勝ち上がる。|'
      '終了、{score}、決めたのはPK戦だった。{pens}、{club}のカップ戦はここで'
          '終わる。',
  ...
  'matchtrait.when.home': "ホームで",
  'matchtrait.when.away': "アウェイで",
  'matchtrait.when.strongerOpponent': "格上相手に",
  'matchtrait.when.firstTwenty': "最初の20分",
  'matchtrait.when.relegationZone': "降格圏にいるとき",
  'matchtrait.when.lastFifteen': "ラスト15分",
  'matchtrait.when.cupTie': "カップ戦で",
  'matchtrait.when.superSub': "終盤に投入されたとき",
  'matchtrait.when.derby': "ダービーで",
  'matchtrait.when.tenMen': "10人になったとき",
  'matchtrait.when.booked': "警告を受けた後",
  'matchtrait.when.injuryShrug': "負傷したとき",
  'matchtrait.when': "発動条件",
  'matchtrait.effect.rating': "評価+{n}%",
  ...
  'boost.park_the_bus.desc': "全員がボールの後ろへ――25分間、試合を殺す",
  'boost.var_review.name': "VAR判定",
  'boost.var_review.desc': "退場を取り消す――選手はイエローでピッチに残る",
  ...
  'boost.bus.over': "鎖が外れ、再びスペースが生まれる。|ブロックが緩む。両チームがまた走り出す。",
  'boost.var.overturned': "VARが判定を覆した。カードは取り消され、{player}はピッチに残る。|主審がモニターへ向かい、首を振って戻ってきた。{player}は救われた。",
  ...
  'boost.sharp_shooting.name': "シャープシュート",
  'boost.sharp_shooting.desc': "どのチャンスも決定機に — 25分間、決定力が研ぎ澄まされる",
  'boost.quiet_word.name': "そっと一言",
  'boost.quiet_word.desc': "主審にそっと一言 — イエローカードを帳消しに",
  'boost.quiet_word.idle': "警告を受けている選手はいない",
  'boost.sharp.live': "シュートコーチの一言が効いた。どのシュートも入りそうだ。|靴紐を締め直した。来たチャンスは確実に沈めている。",
  'boost.sharp.over': "熱が冷め、チャンスはただのチャンスに戻る。|好調期は終わり。また自力で作り出す番だ。",
  'boost.quiet.wiped': "主審にそっと一言、{player}のイエローは忘れられた。|第4審判が口を挟む。{player}の警告は取り消しだ。",
  'coach.red_card.var_hint': "VAR判定を持っています。試合再開前にベンチから申請しましょう。",
  'coach.injury.physio_hint': "魔法のスポンジを持っています。試合再開前にベンチから使いましょう。",
  'match.active.title': "発動中",
  'match.active.until': "{minute}分まで",
  'matchtrait.name.fortress': "要塞",
  'matchtrait.desc.fortress': "ホームでは揺るがない――ただしホーム限定",
  'matchtrait.name.away_day': "アウェイの英雄",
  'matchtrait.desc.away_day': "敵地を愛する――遠征で輝く",
  'matchtrait.name.big_game': "大一番の男",
  'matchtrait.desc.big_game': "格上相手に本領を発揮する",
  'matchtrait.name.fast_starter': "ロケットスタート",
  'matchtrait.desc.fast_starter': "序盤から飛ばす――最初の20分で圧倒的",
  'matchtrait.name.relegation_scrapper': "残留の闘士",
  'matchtrait.desc.relegation_scrapper': "降格が現実になるほど激しく戦う",
  'matchtrait.name.last_gasp': "土壇場",
  'matchtrait.desc.last_gasp': "終盤にもう一つ何かを見つける",
  'matchtrait.name.cup_fighter': "カップ戦の男",
  'matchtrait.desc.cup_fighter': "カップ戦のために生まれた――他では出ない闘志",
  'matchtrait.name.super_sub': "スーパーサブ",
  'matchtrait.desc.super_sub': "残り20分でベンチから出れば破壊的",
  'matchtrait.name.derby_devil': "ダービーの悪魔",
  'matchtrait.desc.derby_devil': "因縁の一戦に生きる",
  'matchtrait.name.ten_man_wall': "十人の壁",
  'matchtrait.desc.ten_man_wall': "十人を束ねる――ピッチに残る全員を引き上げる",
  'matchtrait.name.ice_veins': "冷静沈着",
