...
const Map<String, String> frCopy = <String, String>{
  ...
  'match.subs.pick_off': 'Touche un joueur à sortir.',
  'match.subs.pick_on': 'Touche un remplaçant à faire entrer (vert = meilleur poste).',
  'match.subs.none_left': 'Plus de remplacements.',
  'match.subs.feed': '{off} sort, {on} entre.',
  'match.subs.feed_on': '{on} entre en jeu.',
  'tut.loan_boost.title': '⭐ Des stars en prêt arrivent !',
  'tut.loan_boost.body': 'J\'ai fait jouer quelques relations… des <strong>grands joueurs</strong> ont accepté de nous rejoindre pour ton premier match ! Ils repartent juste après — profitons-en à fond !',
  'tut.loan_boost.btn': 'Voir mon effectif →',
  'tut.loan_depart.title': 'Maintenant, construisons notre équipe',
  'tut.loan_depart.body': 'Les stars prêtées sont reparties — mais elles ont prouvé qu\'on pouvait rivaliser. Maintenant, on construit quelque chose qui est <strong>à nous</strong>. Voici <strong>500 pièces</strong> pour démarrer. Je serai en bas à gauche dès que j\'aurai un conseil à donner.',
  'tut.loan_depart.btn': 'Construisons ! →',
  'difficulty.switch.confirm': 'C\'est parti',
  'difficulty.switch.toHard': 'Mode Pro : chaque joueur se fatigue pendant un match — gère l\'énergie de ton effectif et fais tourner le banc pour garder des jambes fraîches. Je peux t\'aider à choisir ton onze le plus frais, mais je resterai muet sur la tactique. Changer te fera recommencer à zéro.',
  'difficulty.switch.toEasy': 'Mode Décontracté : pas de fatigue des joueurs, le banc ne sert qu\'aux changements tactiques et aux blessures. La sélection auto et les conseils du coach reviennent. Changer te fera recommencer à zéro.',
  'coachtip.subs_bench.title': 'Tu as un banc',
  'coachtip.subs_bench.body': 'Touche Remplaçants pendant un match pour ouvrir ton banc — tu as 5 changements par match, et le chrono s\'arrête pendant que tu choisis. Les blessures y passent aussi maintenant : quand quelqu\'un tombe, son maillot quitte le terrain et la place reste vide jusqu\'à ce que tu fasses entrer un remplaçant, alors ne le laisse pas comme ça.',
  'coachtip.try_hard_mode.title': 'Envie d\'un défi ?',
  'coachtip.try_hard_mode.body': 'Tu as fait du chemin, patron. Prêt pour le mode Pro ? Les joueurs se fatiguent pendant les matchs, alors faire tourner l\'effectif et travailler le banc compte vraiment — touche Auto et je choisirai ton onze légal le plus frais — et je resterai muet sur la tactique. Ça démarre une équipe toute neuve — seulement si tu es partant.',
  'coachtip.try_hard_mode.cta': 'Ouvrir les Réglages',
  'coach.match.tired': '{name} est épuisé — fais entrer un joueur frais !',
  'coach.tactic_tip.open_dominant': 'Les deux équipes vont marquer mais on est clairement plus forts. {tactic} — joue la victoire.',
  'coach.tactic_tip.open_favoured': 'Les deux équipes vont se créer des occasions et on devrait s\'en sortir. {tactic} pour contrôler le match.',
  'coach.tactic_tip.open_even': 'Les deux équipes vont se créer des occasions. {tactic} — frappe {opp} en contre.',
  'coach.tactic_tip.open_underdog': '{opp} sont plus forts mais le match sera ouvert. {tactic} — saisis tes occasions quand elles se présentent.',
  'coach.tactic_tip.exploit_their_def': 'La défense de {opp} est à découvert. {tactic} — joue la victoire.',
  'coach.tactic_tip.counter_their_atk': '{opp} sont dangereux vers l\'avant. {tactic} — encaisse et repars en contre.',
  'coach.tactic_tip.park_underdog': '{opp} sont une vraie menace et on aura du mal à marquer. {tactic} — limite la casse.',
  'coach.tactic_tip.tight_favoured': 'Un match serré mais on a l\'avantage. {tactic} — crée l\'occasion.',
  'coach.tactic_tip.tight_underdog': 'Difficile de marquer des deux côtés. {tactic} — reste discipliné.',
  'ach.cat.hardmode': 'Mode Pro',
  'toast.energy_refilled': 'Énergie de l\'effectif rechargée !',
  'toast.no_fit_players': 'Pas assez de joueurs en forme — laisse-les se reposer ou regarde une pub pour recharger.',
  'trait.name.iron_lungs': 'Poumons de fer',
  'trait.desc.iron_lungs': 'Moteur increvable — l\'énergie baisse plus lentement pendant les matchs (mode Pro)',
  'champ.title': 'CHAMPIONS !',
  'champ.subtitle': 'Ligue des Champions conquise',
  'champ.body': 'Tu as conquis toutes les divisions et surpassé tous tes rivaux. Tu es seul au sommet, le plus grand manager du monde.',
  'champ.prestige_teaser': 'Recommence et regravis les échelons depuis la Ligue du Dimanche avec un <strong>bonus de revenus ×{mult}</strong> permanent. Les succès de ta carrière restent acquis pour toujours.',
  'champ.new_adventure': '🌟 Commencer une nouvelle aventure',
  'champ.defend': '⚽ Défendre le titre',

  // ── The side dial on the squad tab ────────────────────────────────────
  'squad.side.label': 'Attaquer par',
  'squad.side.balanced': 'Équilibré',
  'squad.side.balanced.hint': 'Les attaques partent là où la formation les place.',
  'squad.side.left': 'La gauche',
  'squad.side.left.hint': 'La plupart des attaques partent côté gauche.',
  'squad.side.centre': 'Le centre',
