...
const Map<String, String> frCopy = <String, String>{
  ...
  'coach.bid.relay': '{club} ont appelé, coach. Ils veulent {player} et mettent {price} sur la table. Tu perds ses revenus de +{rate}.',
  'coach.sponsor.title': "Contrat de sponsoring",
  ...
  'squad.matchtrait': "Trait de match",
  'squad.traits': "Traits",
  ...
  'matchtrait.when.home': "À domicile",
  'matchtrait.when.away': "À l'extérieur",
  'matchtrait.when.strongerOpponent': "Contre plus fort",
  'matchtrait.when.firstTwenty': "Les vingt premières minutes",
  'matchtrait.when.relegationZone': "En zone de relégation",
  'matchtrait.when.lastFifteen': "Les quinze dernières minutes",
  'matchtrait.when.cupTie': "En coupe",
  'matchtrait.when.superSub': "Entré tard",
  'matchtrait.when.derby': "Dans un derby",
  'matchtrait.when.tenMen': "À dix",
  'matchtrait.when.booked': "Après un jaune",
  'matchtrait.when.injuryShrug': "Sur blessure",
  'matchtrait.when': "Quand",
  'matchtrait.effect.rating': "+{n}% de note",
  ...
  'boost.park_the_bus.desc': "Tout le monde derrière le ballon — un match verrouillé pendant vingt-cinq minutes",
  'boost.var_review.name': "Recours à la VAR",
  'boost.var_review.desc': "Annuler une expulsion — le joueur reste sur le terrain, avec un jaune",
  ...
  'boost.bus.over': "Les chaînes tombent, et il y a de nouveau de l'espace.|Le bloc se relâche. Les deux équipes peuvent rejouer.",
  'boost.var.overturned': "La VAR annule la décision. Le carton est retiré et {player} reste en jeu.|L'arbitre va à l'écran et revient en secouant la tête. {player} est gracié.",
  'boost.physio.recovered': "{player} se relève, repousse la civière et continue.|Le soigneur fait des miracles. {player} est debout et reste en jeu.",
  'boost.shop.pack': "Pack de {n}",
  'boost.shop.owned': "Vous en avez {n}",
  ...
  'boost.sharp_shooting.name': "Finition létale",
  'boost.sharp_shooting.desc': "Chaque occasion est bonne — notre finition s'affûte pendant vingt-cinq minutes",
  'boost.quiet_word.name': "Mot discret",
  'boost.quiet_word.desc': "Un mot à l'oreille de l'arbitre — un carton jaune est effacé",
  'boost.quiet_word.idle': "Personne n'a de jaune",
  'boost.sharp.live': "L'entraîneur des attaquants a parlé. Chaque tir semble rentrer.|Crampons serrés. Les occasions sont converties.",
  'boost.sharp.over': "Le radar refroidit, une occasion redevient une occasion.|La période faste s'achève. Il faut de nouveau les mériter.",
  'boost.quiet.wiped': "Un mot discret à l'arbitre, et le jaune de {player} est oublié.|Le quatrième arbitre intervient. L'avertissement de {player} passe à la corbeille.",
  'coach.red_card.var_hint': "Vous avez un Recours à la VAR. Lancez-le depuis le banc avant la reprise.",
  'coach.injury.physio_hint': "Vous avez une Éponge du soigneur. Utilisez-la depuis le banc avant la reprise.",
  'match.active.title': "Actifs",
  'match.active.until': "jusqu'à la {minute}e",
  'matchtrait.name.fortress': "Forteresse",
  'matchtrait.desc.fortress': "Inébranlable à domicile — mais seulement à domicile",
  'matchtrait.name.away_day': "Héros des déplacements",
  'matchtrait.desc.away_day': "Adore les stades hostiles — brille loin de chez lui",
  'matchtrait.name.big_game': "Joueur des grands soirs",
  'matchtrait.desc.big_game': "Répond présent face aux meilleurs",
  'matchtrait.name.fast_starter': "Démarrage canon",
  'matchtrait.desc.fast_starter': "Parti comme une flèche — énorme pendant les vingt premières minutes",
  'matchtrait.name.relegation_scrapper': "Bagarreur du maintien",
  'matchtrait.desc.relegation_scrapper': "Se bat le plus fort quand la relégation menace",
  'matchtrait.name.last_gasp': "Dernier souffle",
  'matchtrait.desc.last_gasp': "Trouve encore quelque chose dans les dernières minutes",
  'matchtrait.name.cup_fighter': "Homme de coupe",
  'matchtrait.desc.cup_fighter': "Fait pour la coupe — rien d'autre ne réveille cette hargne",
  'matchtrait.name.super_sub': "Super remplaçant",
  'matchtrait.desc.super_sub': "Dévastateur en sortant du banc dans les vingt dernières minutes",
  'matchtrait.name.derby_devil': "Diable du derby",
  'matchtrait.desc.derby_devil': "Vit pour le match de la rancune",
  'matchtrait.name.ten_man_wall': "Mur à dix",
  'matchtrait.desc.ten_man_wall': "Rallie les dix — porte tous ceux qui restent sur le terrain",
  'matchtrait.name.ice_veins': "Sang-froid",
  'matchtrait.desc.ice_veins': "Joue pareil avec un carton — la tête la plus froide du jeu",
  ...
  'boost.pitch.none': "Plus aucun – achetez-en dans la Boutique",
};
