...
class _ManagerCustomiserState extends ConsumerState<ManagerCustomiser> {
  ...
  Future<void> _watchForItem(String kind, String id) async {
    ...
    // grant — and the flag is app-wide now rather than this sheet's own. A
    // refusal says so on its own too. See `watchRewardedAd`.
...
class _LockedOfferBar extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final watching = ref.watch(adLoadingProvider(lookPackPlacement));
    return Container(
