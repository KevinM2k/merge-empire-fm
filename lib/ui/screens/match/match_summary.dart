              ...
              Expanded(
                ...
                child: ReportScroll.list(
                  ...
                  children: [
                    ...
                    // **AND THEN SOMEBODY WRITES IT UP.** Everything above is
                    // the match in figures; this is the match in words, and it
                    // is the half a player actually reads. It sits under the
                    // scoreline and above the table because that is the order
                    // the sentences are in — the last two beats are where the
                    // table left us and who is next, so the table follows the
                    // paragraph that refers to it.
                    MatchReportCard(result: result),
                    const SizedBox(height: 12),
