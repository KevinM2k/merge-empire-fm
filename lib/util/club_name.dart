...
const List<String> _strong = [
  'nigger', 'nigga', 'faggot', 'retard', 'motherfuck', 'fuck', 'shit',
  'bitch', 'whore', 'rapist', 'paedo', 'wetback', 'tranny', 'pussy',
  'jizz', 'hitler', 'jihad',
];
...
const List<String> _word = [
  'ass', 'hell', 'damn', 'crap', 'sex', 'anal', 'anus', 'tit', 'tits',
  'cunt', 'cock', 'dick', 'cum', 'coon', 'spic', 'chink', 'dyke', 'rape',
  'pedo', 'slut', 'twat', 'wank', 'kike', 'fag', 'nazi', 'kkk', 'isis',
  'penis', 'vagina', 'bastard',
];
